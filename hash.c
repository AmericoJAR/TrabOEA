...
//                        fprintf(arqlog, "Lido do Hash (LOOP) - Posição: %ld - CEP: %ld - PosArq: %ld - Prox: %ld\n",
//                                        ht.Proximo, htant.CEP, htant.PosArq, htant.Proximo);
//	                }
